...
conda convert -f -p linux-32 ~/anaconda/conda-bld/osx-64/arcgis-1.2.0-py35_1.tar.bz2 -o ___output
conda convert -f -p linux-32 ~/anaconda/conda-bld/osx-64/arcgis-1.2.0-py36_1.tar.bz2 -o ___output
conda convert -f -p linux-64 ~/anaconda/conda-bld/osx-64/arcgis-1.2.0-py35_1.tar.bz2 -o ___output
conda convert -f -p linux-64 ~/anaconda/conda-bld/osx-64/arcgis-1.2.0-py36_1.tar.bz2 -o ___output
