...
conda convert -f -pall ~/anaconda/conda-bld/osx-64/arcgis-1.0-py35_1.tar.bz2 -o ___output
conda convert -f -pall ~/anaconda/conda-bld/osx-64/arcgis-1.0-py34_1.tar.bz2 -o ___output
