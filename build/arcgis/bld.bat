...
copy %TRACKER_PATH%\TrackingEngine.dll arcgis\learn\_tracking\_track_processor.pyd /Y
copy %TRACKER_PATH%\_track_processor.pyd arcgis\learn\_tracking\tracking_engine.dll /Y
