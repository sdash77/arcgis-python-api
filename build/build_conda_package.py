...
def _parse_cmd_line_args():
    parser = argparse.ArgumentParser(description = "Builds arcgis conda "\
        ...
        "using build/arcgis/default_meta.yaml if you don't specify "\
        "-o, -p, or --all")
    ...
    parser.add_argument("-q", "--quiet", action="store_true",
        help="Supress DEBUG log messages from STDOUT")
...
def build_conda_pkg(os_build_target = DEFAULT_OS,
    ...
    _setup_meta_yaml_file_for(os_build_target, python_version)
    _run_conda_build_command(python_version = python_version)
    _restore_default_meta_yaml()
...
def _setup_meta_yaml_file_for(os_build_target, python_version):
