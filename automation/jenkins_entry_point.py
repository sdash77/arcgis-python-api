...
_regex_and_funcs = [
    ...
    (LINUX_SLAVE_REGEX, [build_conda_package, publish_to_ftp_site]),
    (GEOS_PULL_REQUEST_REGEX, [run_test_suite, build_documentation]),
    (PUB_REPO_PULL_REQUEST_REGEX, [build_dummy_dev_site]),
    (PUBLISH_REGEX, [build_conda_package, publish_to_ftp_site]),
...
def _parse_args():
    parser = argparse.ArgumentParser(
        description="Call the correct funcs "
    ...
    parser.add_argument(
        ...
        "For any tests to run, the dir of cloned arcgis_python_api repo",
    )
    parser.add_argument(
        "--dev-website-repo",
        "-d",
