...
def build_dev_website_and_publish(dev_website_repo, html_output_dir, *args, **kwargs):
    ...
    run_shell_command(
        f"cd {dev_website_repo} && " "git reset --hard && " "git clean -fd"
    )
    recursive_file_copy(
        src_dir_root=staging_dev_site_dir,
