...
### Description
_A clear and concise description of the problem. Include relevant details such as version number, environment, and any specific conditions that trigger the issue._



### Justification
_Provide a detailed explanation of why this patch release is necessary. Consider the following points:_
...
_Provide a step-by-step guide to reproduce the issue. This helps in validating and testing the fix._
1. Step 1
2. Step 2
3. Step 3

### Expected Behavior
_Describe what you expected to happen when following the steps above._

### Actual Behavior
_Detail what actually happens, contrasting with the expected behavior._

### Additional Information
_Include any relevant logs, screenshots, or additional context that can help in understanding and resolving the issue._

### Proposed Fix
_(Optional) If you have a suggestion for how to fix the issue, describe it here._
