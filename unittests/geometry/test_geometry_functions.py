#-------------------------------------------------------------------------------
# Name:        Tests for geometry operations
...
#TestModule
@unittest.skipIf(module_skip, "Precondition check failed. Skipping tests in Geometry module")
def setUpModule():
    """
    Set up code for full arcgis.geometry module tests
    :return:
    """
...
class Test_geometry_functions_portal(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.qalab_cls_path = cls.qalab_base_path + _conf_reader2['test_data']['geometry_mod_functions']
        #endregion
        ...
        print("==================================================================")
        print("Beginning tests in test_geometry_functions_portal class")
        #endregion

    def setUp(self):
        test_skip = False #reset the skip flag
        print("Test: "+self._testMethodName)
        self.namePrefix = "dino_geometry_"
    ...
    def test_project_point_webmerc_wgs84(self):
        ...
        try:
            ...
            input_geometries = [{"x": -17568824.55, "y": 2428377.35}, {"x": -17568456.88, "y": 2428431.352}]

            #project
            project_return = geometry.project(input_geometries, 3857, 4326, gis=self.gis)

            #validate
            if project_return is None:
                self.fail("Failed to project a known point array")
            else:
                #validate return type
                self.assertIsInstance(project_return, list, "Project did not return a list of geometries")

                #validate values
                correct_geometries = [{"x": -157.82343617279275, "y": 21.305781607280093}, {"x": -157.8201333369876, "y": 21.306233559873714}]
                self.assertEqual("some mismatch", correct_geometries, "Project values mismatch")
...
class Test_geometry_functions_AGO(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        print("==================================================================")
        print("Beginning tests in test_geometry_functions_AGO class")
        # endregion
    ...
    def test_project_point_webmerc_wgs84(self):
        ...
        try:
            ...
            if project_return is None:
                ...
                # validate values
                correct_geometries = [{"x": -157.82343617279275, "y": 21.305781607280093},
