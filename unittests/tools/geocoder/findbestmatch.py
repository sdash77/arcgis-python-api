...
class TestToolsGeocoder_Findbestmatch(unittest.TestCase):
    __owner__ = "Kevin"
    ...
    def testFindBestMatch(self):
        geocode = self.gis.tools.geocoder
        findres = geocode.find_best_match("380 New York St, Redlands")
        self.assertEqual(findres, (34.05649020076322, -117.1956658832732) )
