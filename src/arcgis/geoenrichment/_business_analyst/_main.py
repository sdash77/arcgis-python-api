...
class Country(AOI):
    ...
    def _enrich_local_legacy(
        ...
        **kwargs,
        ...
        self._set_local_ba_analysis_sources()
        ...
        mtch_df = self.get_enrich_variables_from_iterable(enrich_df.columns).set_index(
            "enrich_field_name"
        )
        col_lst = [
...
class BusinessAnalyst(object):
    ...
    def _get_enrich_variables_gis(self, iso3: str = None) -> pd.DataFrame:
    ...
    def _enrich_gis(
        ...
        **kwargs,
        ...
        # hand off to async function to process with not-blocking logic
        enrich_res_df = asyncio.run(
