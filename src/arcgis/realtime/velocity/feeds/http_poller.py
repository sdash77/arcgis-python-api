...
class HttpPoller(_FeedTemplate, _HasTime, _HasGeometry):
    ...
    **Argument**             **Description**
    ...
    -------------------      --------------------------------------------------------------------
    http_auth_type           Union[:class:`~arcgis.realtime.velocity.NoAuth`, :class:`~arcgis.realtime.velocity.BasicAuth`, :class:`~arcgis.realtime.velocity.CertificateAuth`,OAuth]. An instance that contains the
