from ._feed_template import FeedTemplate
...
@dataclass
class RSS(FeedTemplate, _HasTime, _HasGeometry):
    """
    ...
    **Optional Argument**           **Description**
    ...
    time                   Union[TimeInstant, TimeInterval]. An instance of time configuration that
                           will be used to create time info fromt he incoming data.
    ------------------     --------------------------------------------------------------------
    ...
    def __post_init__(self):
        ...
        # generate dictionary of this feed object's properties that will be used to query test-connection and sample-messages Rest endpoint
