...
class Version(object):
    ...
    **Parameter**        **Description**
    ...
    flc                 Optional :class:`~arcgis.features.FeatureLayerCollection` . This is the parent container that
                        the branch versioning is enabled on.
    ---------------     --------------------------------------------------------------------
    session_guid        Optional String. A session id generated by the client used to create
                        and release locks associated with reading and editing the version. If
                        no session_guid is provided, a new one will be generated.
    ---------------     --------------------------------------------------------------------
    ...
    def __init__(self, url, flc=None, gis=None, session_guid=None, mode=None):
        ...
        self._gis = gis
        self._con = self._gis._portal.con
        self._guid = (session_guid or f"{{{uuid.uuid4()}}}").upper()
        self._flc = flc
