...
class TaskManager(_BaseKube):
    ...
    # ---------------------------------------------------------------------
    def edit_task(self, task_id:str, title, type, parameters, item_id, start_date, end_date, minute, hour, day_of_month, month, day_of_week, max_occurences):
        """
    ...
    # ---------------------------------------------------------------------
    def create_task(self, type:str, parameters:dict, minute, hour, day_of_month, month, day_of_week, title, start_date, end_date, max_occurence):
        """
        ...
        params={"f":"json", "type":type, "parameters": parameters, "minute":minute, "hour":hour, "dayOfMonth":day_of_month, "month":month, "dayOfWeek": day_of_week}
        if title:
            params["title"]=title
        if start_date:
