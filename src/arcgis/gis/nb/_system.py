...
class ContainerNotebook(object):
    ...
    def __str__(self) -> str:
        return "<ContainerNotebook at {url}>".format(url=self._url)
...
class WebAdaptor(object):
    ...
    # ----------------------------------------------------------------------
    def __str__(self):
        return "<WebAdaptor at {url} >".format(url=self._url)
...
class WebAdaptorManager(object):
    ...
    # ----------------------------------------------------------------------
    def __str__(self) -> str:
        return "<WebAdaptorManager at {url}>".format(url=self._url)
...
class Container(object):
    ...
    # ----------------------------------------------------------------------
    def __str__(self):
        return "<Container at {url} >".format(url=self._url)
