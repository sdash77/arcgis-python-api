        ...
        **Optional Argument**  **Description**
        ...
        if has_arcpy == False and has_pyshp == False and _is_geoenabled(df):
            ...
            if has_arcpy:
                ...
                # If overwrite specified, perform overwrite
                ...
                if overwrite:
                    ...
                    old_props = flc.manager.properties.layers[fl_index]
                    ...
                    flc_manager.add_to_definition({"layers": [dict(new_props)]})
                    # Step 4: Cleanup
                    if revert:
                ...
                shutil.rmtree(temp_dir, ignore_errors=True)
                # If overwrite specified, perform overwrite on existing Feature Layer
                overwrite = kwargs.pop("overwrite", None)
                if overwrite:
                    # Get user defined parameters
                    fs_dict = kwargs.pop("service", None)
