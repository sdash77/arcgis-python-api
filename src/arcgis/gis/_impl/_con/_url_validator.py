...
_url_pattern = re.compile(_regex)
...
def validate_url(value, public=False):
    ...
    This validator is based on `URL validator of dperini`_.
    .. _URL validator of dperini:
        https://gist.github.com/dperini/729294

    Additional regex expression for IPv6 borrowed from `validator`
    ...
    Examples::
        ...
        True
        >>> validate_url('http://foobar.d')
        False
        >>> validate_url('http://10.0.0.1', public=True)
        False
    ...
    """
    result = _url_pattern.match(value)
    if not public:
        return (result is None) == False
