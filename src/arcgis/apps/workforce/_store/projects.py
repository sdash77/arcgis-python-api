...
def _v1_create_worker_webmap(gis, folder_name, assignments_item, workers_item, tracking_item, assignments_popup_def,
    ...
    webmap_data["operationalLayers"].append(_v1_build_operational_layers(tracking_item, visibility=False))
    webmap_data["operationalLayers"].append(_v1_build_operational_layers(assignments_item, assignments_popup_def))
    webmap_data["operationalLayers"].append(_v1_build_operational_layers(workers_item, workers_popup_def))
...
def _v1_create_application_properties():
    """
...
def _v1_build_operational_layers(item, popup_def=None, visibility=True):
    """
