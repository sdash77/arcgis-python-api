...
def tabulate_area(
    ...
    **Argument**                             **Description**
    ...
    ------------------------------------     --------------------------------------------------------------------
    class_field                              Optional integer or string. The field that defines each class. It can be an
    ...
    ------------------------------------     --------------------------------------------------------------------
    output_name                              Optional string. Optional string. Name of the output feature item or table item to be created.
