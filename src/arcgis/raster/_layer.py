    ...
    def import_tiles(
        ...
        **Parameter**        **Description**
        ...
        .. code-block:: python
            ...
            from arcgis.mapping_layers import ImageryLayer
...
class Raster:
    ...
    **Parameter**                             **Description**
    ...
    cmap                                     Optional str. When displaying a 1 band raster in a
                                             ...
                                             to apply to the raster. See :meth:`arcgis.mapping_layers.symbol.display_colormaps`
    ...
    def cmap(self):
        ...
        .. note::
            The ``cmap`` value must be a string. See :attr:`arcgis.mapping_layers.symbol.display_colormaps`
            for a list of compatible values.
        """
        return self._cmap
