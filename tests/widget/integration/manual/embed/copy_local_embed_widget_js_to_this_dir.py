...
def copy_local_embed_widget_js_to_this_dir():
    ...
    EMBED_WIDGET_JS_FILE = os.path.join(
        GEOSAURUS_ROOT_DIR, "src", "arcgis", "widgets", "js", "dist", "index.js"
    )
    ...
    return shutil.copy(EMBED_WIDGET_JS_FILE, os.path.join(curr_dir, OVERRIDE_JS_FILE))
