...
class TestAppend(unittest.TestCase):
    ...
    def test_upload_item_id(self):
        ...
        mfl._con.post.assert_called_with(path=expected_url, postdata=expected_postdata)

    def test_append_upload_id(self):
        upload_id = "da78c9fb55bb5e44e44c6f88ee7d4ee4"
        mfl = MockFeatureLayer()
        FeatureLayer.append(mfl, upload_id=upload_id, upsert=True)
