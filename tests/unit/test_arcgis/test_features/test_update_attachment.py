...
class TestUpdateAttachments(unittest.TestCase):
    ...
    def test_update_attachments(self):
        ...
        expected_postdata = {"f": "json", "attachmentId": "8"}
    ...
    def test_update_attachments_dynamic_layer(self):
        mfl = MockFeatureLayer()
        mfl._dynamic_layer = {"dynamic": "layer"}
        mfl.url = (
            "https://example.com/server/rest/services/Hosted/"
        ...
        expected_url = (
            f"https://example.com/server/rest/services/Hosted/"
