...
_builder.BuildTopDescriptorsAndMessages(
    DESCRIPTOR, "esriPBuffer.graph.DeleteFieldResponse_pb2", globals()
)
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _GRAPHPROPERTYDELETERESPONSE._serialized_start = 106
    _GRAPHPROPERTYDELETERESPONSE._serialized_end = 176
