...
class TestTypeKeywords(unittest.TestCase):

    @patch("arcgis.widgets.MapView", MockMapView)
    def test_type_keyword_no_item(self):
    ...
    @patch("arcgis.widgets.MapView", MockMapView)
    def test_type_keyword_discard_offline(self):
    ...
    @patch("arcgis.widgets.MapView", MockMapView)
    def test_type_keyword_discard_collector(self):
        """Tests that WebMap._eval_map_viewer_keywords discards the
    ...
    @patch("arcgis.widgets.MapView", MockMapView)
    def test_type_keyword_offline_disabled(self):
        """Tests that WebMap._eval_map_viewer_keywords discards the
    ...
    @patch("arcgis.widgets.MapView", MockMapView)
    def test_type_keyword_collector_disabled(self):
        """Tests that WebMap._eval_map_viewer_keywords discards the
