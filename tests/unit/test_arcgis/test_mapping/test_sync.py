...
class TestSync(unittest.TestCase):
    ...
    def test_two_sync(self, mock_dlink):
    ...
    @patch("ipywidgets.dlink")
    def test_two_unsync(self, mock_dlink):
        mock_mapview1 = MockMapView()
        mock_mapview2 = MockMapView()
    ...
    @patch("ipywidgets.dlink")
    def test_three_sync_unsync(self, mock_dlink):
        mock_mapview1 = MockMapView()
        mock_mapview2 = MockMapView()
    ...
    def test_assert_correct_internal_methods_are_called(self):
        mock_mapview1 = MockMapView()
