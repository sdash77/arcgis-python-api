...
def run_suite(
    ...
    if "unit_tests_to_run" in suite and suite["unit_tests_to_run"]["paths"]:
        xml_output, coverage_output = run_unit_tests(
    ...
    if (
        "integration_tests_to_run" in suite
        and suite["integration_tests_to_run"]["paths"]
    ):
        xml_output, coverage_output = run_integration_tests(
            suite["integration_tests_to_run"]["config"],
    ...
    if (
        "nbconvert_notebook_tests_to_run" in suite
        and suite["nbconvert_notebook_tests_to_run"]["paths"]
    ):
        xml_output = run_notebook_tests(
            suite["nbconvert_notebook_tests_to_run"]["config"],
    ...
    if (
        "selenium_notebook_tests_to_run" in suite
        and suite["selenium_notebook_tests_to_run"]["paths"]
    ):
        xml_output = run_notebook_tests(
            suite["selenium_notebook_tests_to_run"]["config"],
    ...
    if (
        "widget_unit_tests_to_run" in suite
        and suite["widget_unit_tests_to_run"]["paths"]
    ):
        xml_output = run_widget_unit_tests(
            suite["widget_unit_tests_to_run"]["config"],
