...
# TestModule
@unittest.skipIf(
    module_skip, "Precondition check failed. Skipping tests in Geometry module"
)
def setUpModule():
    """
...
class Test_geometry_functions_portal(unittest.TestCase):
    ...
    def test_project_point_webmerc_wgs84(self):
        ...
        try:
            ...
            # project
            project_return = geometry.project(
                input_geometries, 3857, 4326, gis=self.gis
            )
...
class Test_geometry_functions_AGO(unittest.TestCase):
    ...
    def test_get_envelope_from_point(self):
        ...
        try:
            ...
            self.assertEqual(
                pt_envelope, validation_envelope, "Envelope value is wrong"
            )
    ...
    def test_get_envelope_from_polygon(self):
        ...
        try:
            ...
            self.assertEqual(
                poly_envelope, validation_envelope, "Envelope value is wrong"
            )
