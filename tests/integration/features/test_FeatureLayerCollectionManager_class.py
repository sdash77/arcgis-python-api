...
class Test_FeatureLayerCollectionManager_portal(unittest.TestCase):
    ...
    def test_overwrite_HFS_using_csv(self):
        ...
        data_item = PortalUtils.search_portal_item(
            self.gis, "set1_overwrite_HFS_csv", "CSV"
        )
        ...
        wfl_item = PortalUtils.search_portal_item(
            self.gis, "set1_overwrite_HFS_csv", "Feature Service"
        )
        if wfl_item is None:
    ...
    def test_overwrite_HFS_using_fgdb(self):
        ...
        fgdb_item = PortalUtils.search_portal_item(
            self.gis, "title:set1_overwrite_HFS_fgdb.gdb", "File Geodatabase"
        )
        ...
        wfl_item = PortalUtils.search_portal_item(
            self.gis, "set1_overwrite_HFS_fgdb", "Feature Service"
        )
        if wfl_item is None:
