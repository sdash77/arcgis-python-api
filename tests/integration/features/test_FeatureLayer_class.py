...
class Test_FeatureLayer_portal(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        search_result = PortalUtils.search_portal_item(
            cls.gis, layer_name_delfeatures, "Feature Layer"
        )
        if search_result is not None:
            print("Found necessary feature layer")
    ...
    def test_feature_mod_classes(self):
        ...
        try:
            ...
            self.assertIsInstance(
                flayers2,
                list,
                "FeatureLayerCollection.layers property does not return a list",
            )
            self.assertIsInstance(
                flayers2[0],
                arcgis.features.FeatureLayer,
            ...
            self.assertIsInstance(
                ...
                "FeatureLayer.query() does not return a FeatureSet obj",
            )

            # check Feature objects be obtained from FeatureSet object
            feature_list = fset.features
            self.assertIsInstance(
                feature_list, list, "FeatureSet.features does not return a list"
            )
            f1 = feature_list[0]
            self.assertIsInstance(
                f1,
                arcgis.features.Feature,
                "FeatureSet.features does not return a list of Feature objects",
            )
    ...
    def test_edit_features_updates(self):
        try:
            ...
            # ensure edit success
            self.assertTrue(
                update_result["updateResults"][0]["success"], "Update fails"
            )
            ...
            self.assertEqual(
                f1_post_update.attributes["timestamp_"],
                self.time_stamp,
                "Updates are not reflected in the feature layer",
            )
    ...
    def test_feature_query_as_df_classes(self):
        ...
        try:
            ...
            self.assertIsInstance(
                ...
                "FeatureLayer.query(as_df=True) does not return a DataFrame obj",
            )
            self.assertEqual(
                5, county_featureset.shape[0], "Number of features not correct"
            )
    ...
    def test_delete_features(self):
        try:
            ...
            self.assertIsNotNone(
                delete_features_result, "Got back none from delete_features method call"
            )
            self.assertGreater(
                len(delete_features_result["deleteResults"]),
                0,
                "Length of delete_features call result "
...
class Test_FeatureLayer_online(unittest.TestCase):
    ...
    def test_edit_features_updates(self):
        try:
            ...
            self.assertEqual(
                f1_post_update.attributes["POP2000"],
                37000,
                "Updates are not reflected in the feature layer",
            )
    ...
    def test_feature_query_classes(self):
        ...
        try:
            ...
            self.assertEqual(
                100, len(county_featureset.features), "Number of features not correct"
            )
    ...
    def test_feature_query_as_df_classes(self):
        ...
        try:
            ...
            self.assertEqual(
                100, county_featureset.shape[0], "Number of features not correct"
            )
