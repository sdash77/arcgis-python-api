...
from arcgis.features._data.geodataset.io import (
    from_layer,
    to_featureclass,
    to_sqlite,
    from_featureclass,
...
if HAS_ARCPY:
    ...
    class FeatureSetConversionTest(unittest.TestCase):
        ...
        def test_with_geometry(self):
            ...
            for url in self._fs_urls:
                ...
                self.assertIsInstance(
                    res,
                    SpatialDataFrame,
                    msg="Got type: %s instead of SpatialDataFrame" % type(res),
                )
        ...
        def test_without_geometry(self):
            ...
            self.assertIsInstance(
                res,
                pd.DataFrame,
                msg="Got type: %s instead of pandas.DataFrame" % type(res),
            )
    ...
    class IOTest(unittest.TestCase):
        ...
        def test_to_featureclass_shp(self):
            ...
            sdf = fs.df
            fc = to_featureclass(df=sdf, out_location=self._dir, out_name=self._shp)
        ...
        def test_to_featureclass_fgdb(self):
            ...
            fs = fl.query(where="OBJECTID < 10")
            sdf = fs.df
            fc = to_featureclass(df=sdf, out_location=self._gdb, out_name="fgdb_test")
            self.assertTrue(arcpy.Exists(fc))
    ...
    class SpatailDataFrameTest1(unittest.TestCase):
        ...
        def test_df_geom_to_sdf(self):
            ...
            sdf = SpatialDataFrame(
                df,
                geometry=[
                    arcpy.PointGeometry(arcpy.Point(X=r[0], Y=r[1]))
                    for r in self._coords
                ],
            )
            self.assertTrue(
                isinstance(sdf.geometry.all(), (arcpy.Geometry, _types.Geometry)), True
            )
        ...
        def test_geoextent(self):
            ...
            for geom in [
                ...
                df = pd.DataFrame.from_records(
                    data=[self._attributes[0]], columns=self._col
                )
        ...
        def test_angleAndDistanceTo(self):
            ...
            for geom in self.geom_ptgeoms:
                ...
                res.append(
                    isinstance(
                        sdf.angle_distance_to(second_geometry=self.geom_ptgeoms[0]),
                        pd.Series,
                    )
                )
        ...
        def test_boundary(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                count += 1
                res.append(isinstance(sdf.boundary(), GeoSeries))
            self.assertTrue(all(res))
        ...
        def test_buffer(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.buffer(1), GeoSeries))
            self.assertTrue(all(res))
        ...
        def test_clip(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.clip(geom.extent), GeoSeries))
        ...
        def test_contains(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.contains(geom), GeoSeries))
        ...
        def test_convexhull(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.convex_hull(), GeoSeries))
        ...
        def test_crosses(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.crosses(second_geometry=geom), pd.Series))
        ...
        def test_densify(self):
            ...
            for geom in self.geom_polygon:
                ...
                res.append(
                    isinstance(
                        sdf.densify(method="GEODESIC", distance=10, deviation=1),
                        GeoSeries,
                    )
                )
        ...
        def test_difference(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.difference(second_geometry=geom), GeoSeries))
        ...
        def test_disjoint(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.disjoint(second_geometry=geom), GeoSeries))
        ...
        def test_distanceTo(self):
            ...
            for geom in self.geom_pts:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.distance_to(second_geometry=geom), pd.Series))
        ...
        def test_equals(self):
            ...
            for geom in self.geom_pts:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.equals(second_geometry=geom), pd.Series))
            self.assertTrue(all(res))
        ...
        def test_getArea(self):
            ...
            for geom in self.geom_polygon:
                ...
                res.append(
                    isinstance(
                        sdf.get_area(method="PLANAR", units="SQUAREFEET"), pd.Series
                    )
                )
            self.assertTrue(all(res))
        ...
        def test_getLength(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(
                    isinstance(sdf.get_length(method="PLANAR", units="FEET"), pd.Series)
                )
            self.assertTrue(all(res))
        ...
        def test_getPart(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.get_part(index=0), pd.Series))
            self.assertTrue(all(res))
        ...
        def test_intersect(self):
            ...
            for geom in self.geom_polygon:
                ...
                res.append(
                    isinstance(
                        sdf.intersect(second_geometry=geom, dimension=4), pd.Series
                    )
                )
            self.assertTrue(all(res))
        ...
        def test_overlaps(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.overlaps(second_geometry=geom), pd.Series))
            self.assertTrue(all(res))
        ...
        def test_projectAs(self):
            ...
            for geom in self.geom_polygon:
                ...
                res.append(
                    isinstance(
                        sdf.project_as(spatial_reference=arcpy.SpatialReference(4326)),
                        GeoSeries,
                    )
                )
            self.assertTrue(all(res))
        ...
        def test_symetricalDifference(self):
            ...
            for geom in self.geom_polygon:
                ...
                res.append(
                    isinstance(
                        sdf.symmetric_difference(second_geometry=geom), GeoSeries
                    )
                )
            self.assertTrue(all(res))
        ...
        def test_touches(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.touches(second_geometry=geom), GeoSeries))
            self.assertTrue(all(res) == False)
        ...
        def test_within(self):
            ...
            for geom in self.geom_polygon:
                ...
                sdf = SpatialDataFrame(df, geometry=[geom])
                res.append(isinstance(sdf.within(second_geometry=geom), GeoSeries))
            self.assertTrue(all(res) == False)
