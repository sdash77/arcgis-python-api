...
__all__ = ['ba_local', 'usa_local', 'usa_local_enrich_vars', 'ba_agol', 'usa_agol', 'usa_agol_enrich_vars',
           'universal_enrich_vars', 'polygon_df', 'line_df', 'point_df', 'stdgeo_srs']
...
@pytest.fixture
def ba_local():
    return BusinessAnalyst('local')


@pytest.fixture
def usa_local(ba_local):
    return ba_local.get_country('usa')
...
def ba_agol():
    ...
    return BusinessAnalyst(gis)


@pytest.fixture
def usa_agol(ba_agol):
    return ba_agol.get_country('usa')
...
@pytest.fixture
def universal_enrich_vars(ba_agol):
    return ba_agol.enrich_variables
