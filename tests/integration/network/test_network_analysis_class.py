...
class Test_NetworkAnalysisModule(unittest.TestCase):
    ...
    def test_solve_location_allocation_method(self):
        ...
        try:
            ...
            result = network.analysis.solve_location_allocation(
                facilities=facil, demand_points=demand_points
            )
            if result.solve_succeeded:
                print(result)

            self.assertTrue(
                result.solve_succeeded, "Task Unsuccessful: Routes could not be found."
            )
    ...
    def test_generateServiceAreas_method(self):
        ...
        try:
            ...
            self.assertTrue(
                ...
                "Task Unsuccessful: Unable to generate service areas",
            )
    ...
    def test_ClosestFacilityService_method(self):
        ...
        try:
            ...
            self.assertTrue(
                result.solve_succeeded,
                "Task Unsuccessful: Closest facilities could not be generated",
            )
    ...
    def test_find_nearest_method(self):
        ...
        try:
            ...
            self.assertTrue(
                result, "Task Unsuccessful: Closest facilities could not be generated"
            )
    ...
    def test_OriginDestinationCostMatrix_method(self):
        ...
        try:
            ...
            self.assertTrue(
                result,
                "Task Unsucessful : Origin-Destination cost matrix could not be generated",
            )
    ...
    def test_LocationAllocation_service(self):
        ...
        try:
            ...
            self.assertTrue(
                result.solve_succeeded,
                "Task Unsuccessful: Location Allocation output couldnt be generated.",
            )
    ...
    def test_edit_vehicle_routing_problem_service(self):
        ...
        try:
            ...
            self.assertTrue(
                result.solve_succeeded,
                "Task Unsuccessful: Vehicle Routing Problem could not be solved.",
            )
