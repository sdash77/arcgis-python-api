...
try:
    ...
    from integration.arcgis_learn.properties import data_folder
...
def efficientnet_main():
    ...
    loaded_model = detector.from_model(
        os.path.join(data_path, "models", "test_efficientdet", "test_efficientdet.emd")
    )
    loaded_model_data = detector.from_model(
        os.path.join(
            data_path, "models", "test_efficientdet", "test_efficientdet.dlpk"
        ),
        voc,
    )
