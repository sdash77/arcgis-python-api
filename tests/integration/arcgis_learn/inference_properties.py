...
data_inferencing = {
    ...
    "mmdetection": {
        ...
        "input_path_ms": os.path.join(input_data_path_ms, "MMDetection_ms.tif"),
        "model_path_rgb": os.path.join(saved_models_path, "MMDetection_rgb.dlpk"),
        "model_path_ms": os.path.join(saved_models_path, "MMDetection_ms.dlpk"),
