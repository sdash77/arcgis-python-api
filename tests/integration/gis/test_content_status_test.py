            ...
            if item:
                ...
                for cs in ("authoritative","deprecated",None):
                    ...
                    if cs in ["authoritative","deprecated"]:
                        assert item.content_status in [None,"deprecated","org_authoritative","public_authoritative"]
                    else:
                        assert item.content_status in ["","deprecated","org_authoritative","public_authoritative"]
            env.active_gis = None
            del gis
    #----------------------------------------------------------------------
