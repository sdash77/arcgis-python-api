...
class Test_UserManager_portal_builtin(unittest.TestCase):
    ...
    def test_createUser_has_thumbnail(self):
        ...
        try:
            ...
            try:
                ...
                if user_obj_list is None:
                    ...
                    if created_user is not None:
                        ...
                        print("Checking if thumbnail object is present for user "+ user_name)
                        thumbnail_obj = created_user.get_thumbnail()

                        if thumbnail_obj is not None:
                            print("Thumbnail object was found for new user: " + user_name)
            ...
            self.assertIsInstance(created_user, arcgis.gis.User,
                                  "gis.users.create() does not return a User object")
            self.assertIsNotNone(thumbnail_obj, "Thumbnail object was not found for the new user")
