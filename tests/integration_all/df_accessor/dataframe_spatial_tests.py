...
class DataframeSpatialTests(unittest.TestCase):
    ...
    ## Set Geometry Tests
    ##-------------------------------------------------------------------------
    def test_set_geometry_accessor_series(self):
    ...
    def test_set_geometry_accessor_list(self):
    ...
    def test_set_geometry_accessor_tuple(self):
    ...
    def test_set_geometry_accessor_geo_array(self):
    ...
    def test_set_geometry_accessor_string(self):
    ...
    def test_set_geometry_accessor_string_not_valid(self):
    ...
    ## Plot Tests
    ##-------------------------------------------------------------------------
    def test_plot_no_geom_set(self):
    ...
    #### from_xy
    ##-------------------------------------------------------------------------
    def test_import_gis_content(self):
    ...
    def test_to_featureclass_arcpy(self):
    ...
    # --------------------------------------------------------------------------
    def test_to_featureclass_pyshp(self):
        """
    ...
    def test_from_fc_arcpy_path(self):
    ...
    def test_from_df(self):
        ...
        locations = [
            [0, "12 York Street, Camden, NJ"],
            [1, "646 Kings Hwy, West Deptford, NJ 08096"],
        ]
